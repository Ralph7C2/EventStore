...
namespace EventStore.Core.Services.Transport.Http.Controllers {
	public class PersistentSubscriptionController : CommunicationController {
		...
		protected override void SubscribeCore(IHttpService service) {
			...
			// TODO(pgermishuys) requires a new Operation for Subscriptions. i.e. Operations.Subscriptions.Restart
			Register(service, "/subscriptions/restart", HttpMethod.Post, RestartPersistentSubscriptions, Codec.NoCodecs, DefaultCodecs, new Operation(Operations.Subscriptions.Statistics));
